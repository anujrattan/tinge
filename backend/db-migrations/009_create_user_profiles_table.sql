...
-- This table is linked to auth.users and stores role information
-- Date: 2024
...
-- Comments
COMMENT ON TABLE user_profiles IS 'Stores user profile information including role. Linked to auth.users via id.';
